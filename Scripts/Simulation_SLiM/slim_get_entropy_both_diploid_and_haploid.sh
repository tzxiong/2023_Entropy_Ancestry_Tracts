...
echo Command line:
echo python3 slim_get_entropy_both_diploid_and_haploid.py --dir ${dir} --seed ${seed} --P ${P} --nDiploid ${nDiploid} --L ${L} --nResampling ${nResampling}

python3 slim_get_entropy_both_diploid_and_haploid.py --dir ${dir} --seed ${seed} --P ${P} --nDiploid ${nDiploid} --L ${L} --nResampling ${nResampling}